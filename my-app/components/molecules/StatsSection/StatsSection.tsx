...
const StatsSection = ({ stats, title }: StatsSectionProps) => {
  return (
    <div className="mt-[327px] sm:mt-[151px]">
      <h2 className="text-[24px] font-semibold text-[#3A1700] text-center mb-8 mx-auto w-[55%] sm:w-[85%] font-rowdies ">{title}</h2>

      <div className="flex sm:flex-wrap lg:flex-wrap lg:justify-center justify-between gap-8 mt-[42px] sm:justify-center">
