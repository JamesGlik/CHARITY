...
export default function CauseCard({ category, title, raised, goal, imageSrc }: CauseCardProps) {
  return (
    <div className="w-[370px] sm:w-[329px] h-[560px] bg-[#F3F2E7] rounded-lg shadow-md">
      ...
      <div className="p-8">
        <h3 className="pt-4 text-[24px] font-rowdies font-bold text-[#3A1700] sm:text-[22px]">{title}</h3>
        <div className="pt-[33px] text-gray-600">
        ...
        <div className="pt-[40px] font-rowdies">
