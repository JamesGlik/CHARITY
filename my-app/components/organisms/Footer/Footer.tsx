...
function Footer({
  ...
  return (
    <footer className="bg-[#D58E5E] px-[135px]">
      <div className="mx-auto grid grid-cols-3 max-sm:grid-cols-1">
        <div>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between max-sm:flex-col">
      ...
      <div className="flex flex-row justify-between items-center mt-[70px] pb-[54px] border-t border-white pt-4 opacity-[50%] max-sm:flex-col">
